...
<html>
    <head>
        <meta charset="UTF-8">
        <Title>Steven Universe Wiki - Home</Title>
    ...
    <body>
        ...
        <header>Welcome to the Steven Universe Wiki Page!</header></br></br>
        <div id="options">
          We're a small budget wiki page just looking to provide Steven Universe fans with some basic information. </br></br>
          Feel free to check out all the <a href="characters.php">characters</a>. </br></br>
          Or maybe you would like a list of all the <a href="fusions.php">fusions</a>. </br></br>
          We even have a list of a couple of <a href="locations.php">locations</a> from the show. </br></br>
        </div>
    </body>
</html>